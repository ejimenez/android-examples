...
public class DataQuery<Object> {
    ...
    public FindXMLCallback<DataObject> m_callback_xml  = null;
    ...
    public void findXMLInBackground(String property,Object value,int operator, FindXMLCallback<DataObject> callback) {
        m_callback_xml = callback;
        m_property = property;
        m_operator = operator;
        m_value = value;
        ...
        m_runnable = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    DataLowLevel lowLevel = DataLowLevel.Get();
                    m_string_result = lowLevel.findXML(m_class_name, m_property, m_value, m_operator);
                    Message msg = m_handler.obtainMessage();
                    m_handler.sendMessage(msg);
                }
                catch(Exception err)
    ...
    public Handler m_handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            else if(m_callback_xml!=null) {
                (m_callback_xml).done(m_string_result, null);
            }
